...
export const createStudentAttendance = async (req, res) => {
  ...
  export const getStudentAttendance = async (req, res) => {
    try {
      ...
      const attendanceRecords = await StudentAttendance.find({ student: studentId });
  ...
  export const getAttendanceByDate = async (req, res) => {
    try {
      ...
      }).populate("student", "name department domain"); // Populating to get student details if needed
